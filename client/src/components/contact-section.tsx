    ...
    <section id="contact" className="py-20 bg-cream">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="font-montserrat font-bold text-4xl text-[hsl(var(--nature-olive))] mb-4">
            Ubicación y Contacto
          </h2>
          <p className="text-xl text-[hsl(var(--nature-text))]">
          ...
          <div className="bg-white rounded-xl p-8 shadow-lg">
            ...
            <div className="space-y-4">
              <div className="flex items-center">
                ...
                <span className="text-[hsl(var(--nature-text))]">Barbosa, Antioquia, Colombia</span>
              </div>
              <div className="flex items-center">
              ...
              <div className="flex items-center">
                ...
                <span className="text-[hsl(var(--nature-text))]">Entrada: 3:00 PM | Salida: 11:00 AM</span>
              </div>
            </div>
